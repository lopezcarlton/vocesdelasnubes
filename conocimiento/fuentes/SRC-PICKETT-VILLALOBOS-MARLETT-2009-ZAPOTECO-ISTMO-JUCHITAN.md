...
No colapsar ambas entradas sólo por compartir autores, objeto y parte importante del análisis.

## Uso para Voces

Es una fuente prioritaria para estudiar fonética y escucha de Juchitán, incluidos tono, tipo vocálico, oposición fortis/lenis y realización contextual. Las grabaciones asociadas son especialmente pertinentes para un proyecto centrado en escucha.
