...
# 2. Principales autores y marcos

## 2.1 Stephen Krashen

Se retoman nociones relacionadas con:

- input comprensible;
- exposición de baja presión;
- filtro afectivo;
- adquisición mediante comprensión progresiva.
...
No se adopta como método de enseñanza.

Sirve para:

- anticipar diferencias con el español;
...
El proyecto adopta una postura crítica:

- reconoce el valor descriptivo de materiales del ILV;
- registra su contexto ideológico y evangelizador;
...
# 4. Conceptos o enfoques descartados
...
Se descartan como estructura suficiente para niveles posteriores.
...
La Gramática Popular §6.1 documenta que la comparación en didxazá usa estructuras relativamente simples:

- Verbo "pasar" nativo, O
- Préstamos "que"/"para" + estativo
